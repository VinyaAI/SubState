...
The prototype uses a handwritten schema or one generated by
`substate init`. Later, SubState should deepen discovery (Schema Registry,
field remapping) while still asking the developer only for semantics that
