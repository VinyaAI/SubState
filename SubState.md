...
The schema describes how physical source data becomes logical state.
...
The prototype uses a handwritten schema. Later, SubState should discover
source schemas and generate most of this configuration automatically,
asking the developer only for semantics that cannot safely be inferred.

See the separate Schema Discovery & Synchronization Semantics
document.
